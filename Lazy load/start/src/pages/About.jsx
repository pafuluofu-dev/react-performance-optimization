	...
	return (
		<div className='lg:prose-xl prose'>
			...
			<p>
				...
				providing the best online shopping experience. With a wide range
				of products, competitive pricing, and exceptional customer
				service, we strive to make your shopping journey as seamless as
				possible.
			</p>
			<p>
				Our mission is to connect customers with products they love,
				from trusted sellers around the world. Whether you're looking
				for the latest gadgets, fashion, or home essentials, we've got
				you covered.
			</p>
  ...
  return (
    <div>
      ...
      <p>Find your favorite products here.</p>
			...
			<p>
				Check out our{' '}
				<a href='https://www.example.com'>official website</a> for more
			...
			/>
			<p>
				Join thousands of happy customers who trust us with their
				shopping needs.
			</p>
		</div>
	);
